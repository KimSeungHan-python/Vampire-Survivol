...
[CreateAssetMenu(fileName = "Character Data", menuName = "2D Top-down Rouge-Like/Character Data")]
public class CharacterData : ScriptableObject
{
    ...
    public struct Stats
    {
        ...
        public Stats(float maxHealth = 1000, float recovery = 0, float moveSpeed =1f, float might = 1f, float magnet = 30f)
        {
