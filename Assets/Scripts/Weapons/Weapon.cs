...
public abstract class Weapon : Item
{
    ...
    public struct Stats
    {
        ...
        [Header("Visuals")]
        public ProjectileWeapon projectilePrefab; // if attached, a projectile will spawn every time the weapon cools down
        //public Aura auraPrefab; // if attached, an aura will be created around the player when the weapon is equipped
        ...
        {
            return damage + Random.Range(-damageVariance, damageVariance);
        }
    }
    ...
    {
        //Don't initalise the weapon if the weapon data is not assigned.
        if (data)
        {
            initialise(data);
        }
    ...
    // Gets the amount of damage that he weapon is supposed to deal.
